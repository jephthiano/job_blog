				...
				<div class=''style='margin:15px 0px;'>
					<div class='j-color4'>
						...
						<div class='j-padding '>
							...
							<div class='j-row'>
								<div class='j-col m6'>
									<span class='j-bolder j-text-color7'>Comment:</span>
									<span><?php if(get_json_data('comment','act') == 1){echo 'Enabled';}else{echo 'Disabled';}?></span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class=''style='margin:15px 0px;'>
					<div class='j-color4'>
						...
						<div class='j-padding '>
							...
							<div class='j-row'>
								<div class='j-col m6'>
									<div class='j-bolder j-text-color7'>Delivery Category:</div>
									<div><?=ucwords(get_json_data('category','about_us'))?></div>
								</div>
								<div class='j-col m6'>
								</div>
							</div>
