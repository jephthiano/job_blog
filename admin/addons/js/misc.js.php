...
<?php } ?>
<?php if($_SERVER['PHP_SELF'] === '/admin/admin/preview_admin.enc.php' || $_SERVER['PHP_SELF'] === '/admin/news/preview_news.enc.php'
         || $_SERVER['PHP_SELF'] === '/admin/comment/preview_comment.enc.php'){ ?>
<?php //change status?>
...
<?php if($_SERVER['PHP_SELF'] === '/admin/admin/preview_admin.enc.php'  || $_SERVER['PHP_SELF'] === '/admin/admin/index.php'
      ...
      || $_SERVER['PHP_SELF'] === '/admin/comment/preview_comment.enc.php' ||  $_SERVER['PHP_SELF'] === '/admin/comment/index.php'
      ){ ?>
<?php //delete content ?>
...
<?php if($_SERVER['PHP_SELF'] === '/admin/admin/edit_profile.enc.php' || $_SERVER['PHP_SELF'] === '/admin/admin/insert_admin.enc.php'
         || $_SERVER['PHP_SELF'] === '/admin/partner/insert_partner.enc.php' || $_SERVER['PHP_SELF'] === '/admin/partner/update_partner.enc.php'
         || $_SERVER['PHP_SELF'] === '/admin/news/insert_news.enc.php' || $_SERVER['PHP_SELF'] === '/admin/news/update_news.enc.php'){ ?>
