...
$page_url = file_location('admin_url','subscriber/'.$_GET['page'].'/');
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol">
			<div class='j-padding'>
				<h2 class='j-text-color1 j-padding j-color4'><b>SUBSCRIBERS LIST</b></h2>
			</div>
			<center>				
				<div class="j-container">
					<input type="search"name="sx"id="sx"class="j-input j-border-2 j-border-color1 j-round"
					placeholder="Search all subscribers"style="width:96%;max-width:500px;outline:none;display:inline"onsearch="gsr(<?=$page_num?>);"onkeyup="gsr(<?=$page_num?>);"/>
				</div>
				<div id="shr"></div>
			</center>
			<span id="st"></span>
