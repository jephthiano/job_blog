...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div class='j-padding'>
			<h2 class='j-text-color1 j-padding j-color4'><b>UPDATE NEWS</b></h2>
		</div>
		<div class='j-padding'>
			...
			if($id === false){
				...
				<div class='j-padding'>
					<div id='preview'class='j-border-color5 j-border j-circle j-color5 j-vertical-center-container j-clickable'style='width:100px;height:100px;'
						 onclick="$('#news<?=$id?>_pics_modal').show();">
						<img src='<?=file_location('media_url',get_media('news',$id))?>'alt=''class='j-round j-card-4'style='width:100px;height:100px;border:solid 2px white'>
						<span class='j-text-color4 j-bold j-vertical-center-element'style='font-size:40px;'>+</span>
					</div>
					<?php image_modal('news',$id)?>
				</div>
				<form onsubmit="event.preventDefault();"class=''id='upnw'>
					...
					<div class='j-row'>
						<div class='j-col m6 j-padding'>
							...
							<input type="text"class="j-input j-medium j-border-2 j-border-color5 j-round"placeholder="Title" maxlength='255'
								name="tt"id="tt"value="<?=content_data('news_table','n_title',$cid,'n_id')?>"style="width:100%;"/>
						</div>
						<div class='j-col m6 j-padding'>
							...
							<select name="ct"id="ct"class='j-select j-color4 j-round j-border-2 j-border-color5'style="width:100%;max-width:400px;">
								<option value=''>Select category</option><?php get_category(content_data('news_table','n_category',$cid,'n_id'))?>
							</select>
						</div>
					</div>
					<div class='j-row'>
						<div class='j-col m6 j-padding'>
							...
							<input type="text"class="j-input j-medium j-border-2 j-border-color5 j-round"placeholder="Keywords"
								name="ky"id="ky"value="<?=content_data('news_table','n_keyword',$cid,'n_id')?>"style="width:100%;"/>
						...
						<div class='j-col m6 j-padding'>
							...
							<input type="text"class="j-input j-medium j-border-2 j-border-color5 j-round"placeholder="Image Caption"maxlength='100'
								name="ic"id="ic"value="<?=content_data('news_table','n_imagecaption',$cid,'n_id')?>"style="width:100%;"/>
						</div>
					</div>
					<div class='j-row'>
						<div class='j-col m6 j-padding'>
							<label class="j-large j-text-color7"><b>First Paragraph: </b> <span class='j-text-color1 mg'id='ph1e'>*</span></label>
							<textarea placeholder="First Paragraph"id='ph1'name="ph1"style="width:100%;"rows="4"class="j-input j-medium j-border-2 j-border-color5 j-color4 j-round-large"><?=content_data('news_table','n_paragraph1',$cid,'n_id')?></textarea>
						</div>
						<div class='j-col m6 j-padding'>
							<label class="j-large j-text-color7"><b>Second Paragraph: </b> <span class='j-text-color1 mg'id='ph2e'></span></label>
							<textarea placeholder="Second Paragraph"id='ph2'name="ph2"style="width:100%;"rows="4"class="j-input j-medium j-border-2 j-border-color5 j-color4 j-round-large"><?=content_data('news_table','n_paragraph2',$cid,'n_id')?></textarea>
					...
					<div class='j-row'>
						<div class='j-col m6 j-padding'>
							...
							<textarea placeholder="Third Paragraph"id='ph3'name="ph3"style="width:100%;"rows="4"class="j-input j-medium j-border-2 j-border-color5 j-color4 j-round-large"><?=content_data('news_table','n_paragraph2',$cid,'n_id')?></textarea>
							<span class='j-small j-text-color5'>(optional)</span>
						</div>
					</div>
					<div class='j-row'>
						<div class='j-col m6 j-padding'>
							...
							<input type="text"class="j-input j-medium j-border-2 j-border-color5 j-round"placeholder="Source"maxlength='55'
								name="sc"id="sc"value="<?=content_data('news_table','n_source',$cid,'n_id')?>"style="width:100%;"/>
							<span class='j-small j-text-color5'>(optional)</span>
						</div>
						<div class='j-col m6 j-padding'>
							...
							<input type="text"class="j-input j-medium j-border-2 j-border-color5 j-round"placeholder="DateTime"
								name="rg"id="rg"value="<?=content_data('news_table','n_regdatetime',$cid,'n_id')?>"style="width:100%;"/>
					...
					<div class='j-margin'>
						<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round j-bolder">Update News</button>
					</div>
				</form>
				<?php
			}
