...
$page_url = file_location('admin_url','partner/');
$page = "MANAGE PARTNERS";
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol">
			<div class='j-padding'>
				<h2 class='j-text-color1 j-padding j-color4'><b>PARTNERS LIST</b></h2>
			</div>
			<center>				
				<div class='j-padding'>
					<a href="<?=file_location('admin_url','partner/insert_partner/')?>"class='j-btn j-color1 j-right j-round j-card-4'><b>Insert New Partner</b></a>
				</div>
				<br><br>
				<div class="j-container">
					<input type="search"name="sx"id="sx"class="j-input j-border-2 j-border-color1 j-round"
					placeholder="Search all partners"style="width:96%;max-width:500px;outline:none;display:inline"onsearch="gpr(<?=$page_num?>);"onkeyup="gpr(<?=$page_num?>);"/>
				</div>
				<div id="shr"></div>
			</center>
			<span id="st"></span>
