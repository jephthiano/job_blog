	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol"class='j-main-col'>
			<div class=''style='margin-bottom:20px;'>
				<h2 class='j-text-color1 j-padding j-color4'><b>INSERT NEW PARTNER</b></h2>
			</div>
			<center>
				<a href="<?=file_location('admin_url','partner/')?>" class="j-btn j-color1 j-right j-bolder j-round j-card-4">Show All Partners</a>
				<br class='j-clearfix'>
			</center>
			...
			<form onsubmit="event.preventDefault();"id='inspt'class=''>
				...
				<div class='j-margin'>
					<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round j-bolder">Insert New Partner</button>
				</div>
			</form>
			<span id="st"></span>
			<br><br>
